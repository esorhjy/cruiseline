window.AI_QUERY_TAXONOMY = {
    ...
    aliases: [
        ...
        },
        {
            ...
            terms: ['oceaneer', 'oceaneer club', 'kids club', '兒童俱樂部', '海洋俱樂部']
        },
        {
            canonical: '餐廳',
    ...
    categoryFamilies: [
        {
            id: 'venue',
            label: '場館',
            terms: ['場館', '設施', '地點', '甲板', '樓層', '區域'],
            keywords: ['場館', '設施', '地點', 'deck', '樓層', '區域', '在哪裡']
        },
        {
            id: 'service',
            label: '服務',
            terms: ['服務', '流程', '規則', '限制', '支援'],
            keywords: ['服務', '流程', '規則', '限制', '支援', 'support']
        },
        {
            id: 'show',
            label: '表演',
            terms: ['表演', '秀', '主秀', '劇院', 'shows'],
            keywords: ['表演', '秀', '劇院', 'theatre', 'theater', 'show', 'shows']
        },
        {
            id: 'restaurant',
            label: '餐廳',
            terms: ['餐廳', '正式餐廳', 'dining', 'restaurant'],
            keywords: ['餐廳', '正式餐廳', 'dining', 'restaurant', '晚餐', '用餐']
        },
        {
            id: 'quick-service',
            label: '快餐',
            terms: ['快餐', '點心', '補給', '披薩', 'snack'],
            keywords: ['快餐', '點心', '補給', '披薩', 'pizza', 'snack']
        },
        {
            id: 'shop',
            label: '商店',
            terms: ['商店', '購物', 'shop', 'shopping'],
            keywords: ['商店', '購物', 'shop', 'shopping', '紀念品']
        },
        {
            id: 'game',
            label: '遊戲',
            terms: ['遊戲', '電玩', 'arcade', 'game'],
            keywords: ['遊戲', '電玩', 'arcade', 'game']
        },
        {
            id: 'pool',
            label: '泳池',
            terms: ['泳池', '滑水道', '水區', 'pool', 'slide'],
            keywords: ['泳池', '滑水道', '水區', 'pool', 'slide']
        },
        {
            id: 'kids-club',
            label: '兒童俱樂部',
            terms: ['兒童俱樂部', 'kids club', 'oceaneer', 'open house'],
            keywords: ['兒童俱樂部', 'kids club', 'oceaneer', 'open house', '開放參觀']
        },
        {
            id: 'lounge',
            label: '酒廊',
            terms: ['酒廊', 'lounge', 'bar', '禮賓酒廊'],
            keywords: ['酒廊', 'lounge', 'bar', '禮賓酒廊', '下午茶', '補給']
        },
        {
            id: 'spa-fitness',
            label: 'Spa / 健身',
            terms: ['spa', 'fitness', '健身', '芳療'],
            keywords: ['spa', 'fitness', '健身', '芳療']
        },
        {
            id: 'timing-context',
            label: '時間脈絡',
            terms: ['時間', '時段', '幾點', '早上', '下午', '晚上'],
            keywords: ['時間', '時段', '幾點', '早上', '下午', '晚上', 'timing']
        }
    ],
    clusterRelations: [
        {
            ...
            relatedTerms: ['優先入場', 'priority seating', 'Royal Meet & Greet', '禮賓協助', '下午茶', '補給', 'sundeck', 'fitness', 'spa']
        },
        {
            ...
            relatedTerms: ['Remember', 'Disney Seas the Adventure', '優先入場', '排隊', '座位', '時機提醒', '晚秀']
        },
        {
            key: 'room-service',
            label: 'Room Service 群',
            triggers: ['room service', '客房服務', '房務', '送餐'],
            relatedEntities: ['Room Service'],
            relatedCategories: ['服務', '餐廳', '時間脈絡'],
            relatedTerms: ['宵夜', '早餐', '點餐', '限制', '小費', '送餐']
        },
        {
            key: 'kids-club',
            label: '兒童俱樂部群',
            triggers: ['open house', 'oceaneer', 'kids club', '兒童俱樂部'],
            relatedEntities: ['Open House', 'Oceaneer Club'],
            relatedCategories: ['兒童俱樂部', '遊戲', '場館'],
            relatedTerms: ['開放參觀', '活動', '時段', '孩子', '親子']
        },
        {
            key: 'dining-coverage',
            label: '餐飲盤點群',
        ...
        },
        {
            ...
            relatedEntities: ['禮賓', '劇院', 'Room Service', 'Open House'],
    ...
    relatedEdges: [
        ...
        },
        {
            ...
            terms: ['Concierge Lounge', '下午茶', '補給', '休息']
        },
        {
            source: '劇院',
            target: '表演',
            relation: 'venue-program',
            terms: ['Remember', 'Disney Seas the Adventure', '晚秀', '主秀']
        },
        {
            source: '設施',
            target: '場館',
